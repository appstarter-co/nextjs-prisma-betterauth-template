...
import { ChevronLeftIcon, EyeIcon, EyeOffIcon, X, Mail } from "lucide-react";
...
export default function LoginForm() {
    ...
    const { error: signInError } = await authClient.signIn.email(
      {
        email,
        password,
        // better-auth usually handles "remember" via session cookie config;
        // if supported, you can pass remember: isChecked
      },
      {
  ...
  async function handlePasswordReset(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (error) {
        setResetMessage(error.message || "Failed to send reset instructions");
      } else {
          ...
          <div>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              ...
              <button
                ...
                onClick={async () => {
                  setError("");
                  const { error: xErr } = await authClient.signIn.social(
                    { provider: "twitter" },
                    {
                      onRequest: () => setLoading(true),
                      onError: (ctx) => {
              ...
              >
                ...
                {loading ? "Processing..." : "Sign in with X"}
              </button>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <label
                      htmlFor="remember"
                      className="block text-sm text-gray-700 text-theme-sm dark:text-gray-400 cursor-pointer"
                    >
                      Keep me logged in
                    </label>
                  </div>
    ...
    {/* Password Reset Modal */}
      {isResetModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-900">
            ...
            <div className="p-6">
              {!resetSubmitted ? (
                ...
                <div className="text-center">
                  ...
                  <Button onClick={closeResetpasswordModal} className="w-full">
                    Got It
                  </Button>
                </div>
              )}
